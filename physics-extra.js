(() => {
    ...
    function insertRadiationRiskSection() {
        ...
        section.innerHTML = `
            ...
            <p>Jedan broj u sievertima bez vremena, vrste zračenja i dijela tijela može biti varljiv. Za kasni rizik često se govori u <strong>Sv / mSv</strong>, dok se kod akutnih ozljeda tkiva i akutnog radijacijskog sindroma češće koristi apsorbirana doza u <strong>Gy</strong>. Kod jednoliko raspoređene vanjske gama-doze brojčane vrijednosti Gy i Sv mogu biti sličnog reda jer gama ima radiation weighting factor približno 1, ali to se ne smije generalizirati na neutrone, alfa-zračenje, lokalnu dozu kože ili unutarnju kontaminaciju.</p>

            <div class="physics-table-wrap">
                <table class="physics-table">
                    <thead><tr><th>doza / situacija</th><th>što okvirno znači</th></tr></thead>
                    <tbody>
                        <tr><td><strong>1 mSv u godini</strong></td><td>tipičan regulatorni limit za dodatnu planiranu izloženost člana javnosti; ne uključuje prirodnu pozadinu i medicinski opravdane pretrage</td></tr>
                        <tr><td><strong>20 mSv/god</strong></td><td>uobičajeni međunarodni profesionalni limit, prosječno kroz 5 godina; nije granica između „sigurno” i „otrovno”, nego granica sustava zaštite</td></tr>
                        <tr><td><strong>~100 mSv</strong></td><td>područje u kojem epidemiološki signal porasta rizika raka postaje znatno jasniji; to još nije tipična doza koja sama izaziva akutni radijacijski sindrom</td></tr>
                        <tr><td><strong>~1 Sv primljen brzo po cijelom tijelu</strong></td><td>WHO navodi približno tu razinu kao prag na kojem se može pojaviti akutni radijacijski sindrom; brzina isporuke je ključna</td></tr>
                        <tr><td><strong>~4 Sv / 4 Gy brzo po cijelom tijelu</strong></td><td>CDC kao grubu komunikacijsku vrijednost navodi oko 50% smrtnosti; stvarni ishod ovisi o liječenju, dobi, ozljedama i raspodjeli doze</td></tr>
                        <tr><td><strong>~6–10 Gy brzo po cijelom tijelu</strong></td><td>teški hematopoetski i gastrointestinalni sindrom; CDC navodi da je preživljenje pri GI sindromu vrlo rijetko čak i uz liječenje</td></tr>
                        <tr><td><strong>~10 Sv / 10 Gy i više brzo</strong></td><td>izrazito visoka, često smrtonosna cijelotjelesna doza; nije usporediva s istim ukupnim brojem raspoređenim kroz godine ili ograničenim na mali dio tijela</td></tr>
                    </tbody>
                </table>
            </div>

            <div class="misconception"><strong>Ista ukupna doza nije ista biološka situacija ako je primiš u 30 sekundi ili kroz više godina.</strong> Kod sporije isporuke stanice imaju više vremena za popravak i zamjenu oštećenih stanica. Zato se akutna cijelotjelesna doza od nekoliko Gy ne uspoređuje direktno s profesionalnim limitima izraženima po godini.</div>
            ...
            <p class="deep-source"><a href="https://www.cdc.gov/radiation-emergencies/causes/radiation-thermometer.html" target="_blank" rel="noopener noreferrer">CDC – Radiation Thermometer ↗</a> · <a href="https://www.who.int/news-room/fact-sheets/detail/ionizing-radiation-and-health-effects" target="_blank" rel="noopener noreferrer">WHO – ionizing radiation and health effects ↗</a> · <a href="https://www.who.int/news-room/questions-and-answers/item/radiation-the-chernobyl-accident" target="_blank" rel="noopener noreferrer">WHO – Chernobyl doses ↗</a> · <a href="https://www.unscear.org/unscear/en/areas-of-work/chernobyl.html" target="_blank" rel="noopener noreferrer">UNSCEAR – Chernobyl ↗</a> · <a href="https://www.nek.si/hr/pogon/podrska-pogonu" target="_blank" rel="noopener noreferrer">NE Krško – radiološke doze ↗</a> · <a href="https://www.nek.si/hr/vijesti/izvjesca/izvjesce-o-radu-nek-a-za-kolovoz-2026-" target="_blank" rel="noopener noreferrer">NEK – kolovoz 2026. ↗</a></p>
        `;
